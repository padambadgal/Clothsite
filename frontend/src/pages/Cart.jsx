        ...
        <div className='pt-20 bg-gray-50 min-h-screen'>
            {
                cart?.items?.length > 0 ?
                    <div className='max-w-7xl mx-auto'>
                        <h1 className='text-2xl font-bold text-gray-800 mb-7'>Shoppig Cart</h1>
                                    ...
                                    cart?.items?.map((product, index) => {
                                        return <Card key={index}>
                                            <div className="flex justify-between items-center px-7">
                                                ...
                                                <p onClick={() => { handleRemove(product?.productId?._id) }} className='flex text-red-500 items-center gap-1 cursor-pointer'><Trash2 className='w-4 h-4' /></p>
                                            </div>
                                        </Card>
                                    })
                                }
                        ...
                        <p className='mt-2 text-gray-600'>Looks like  you haven't added anything to you cart yet</p>
                        <Button onClick={() => navigate('/products')} className='mt-6 bg-pink-600 text-white hover:bg-pink-700 py-3 px-6 cursor-pointer'>Start Shopping</Button>
                    </div>
            }
        </div>
    )
